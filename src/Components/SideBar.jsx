...
function SideBar({ setSideBar }) {
    return (
        <div className='sidebarbgcolor min-h-[200vh] w-48 visible md:invisible relative ' >
            ...
            <Link to='aboutus' smooth={true} offset={-70} duration={500} className='headerBtn text-center text-2xl mb-10 font-bold cursor-pointer'>About Me</Link>
            <Link to='latestwork' smooth={true} offset={-30} duration={500} className='headerBtn text-center text-2xl mb-10 font-bold cursor-pointer'>My Work</Link>
