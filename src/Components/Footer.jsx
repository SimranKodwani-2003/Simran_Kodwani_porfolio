      ...
      <div className='w-full m-auto my-10 md:my-0 md:px-8' >
        ...
        <div className='w-full m-auto flex flex-col md:flex-row justify-between items-center pb-4 md:pb-0  border-2 border-transparent border-b-white '>
          <div className='w-full md:w-1/2'>
            <h1 className='text-3xl font-bold pb-2' >Simran Kodwani</h1>
            <p className='pb-4 text-base'>"Connect with me for actionable data analysis solutions and impactful insights. Follow me on social media for updates and trends in data Science."</p>
          </div>
          <div className='w-full md:w-1/2 flex justify-start md:justify-end '>
            ...
            <button className='btn h-10 w-32 bg-pink-600 rounded-full font-semibold ml-2 text-base bg- #f10f8f '>Submit</button>
          </div>
        </div>
        ...
        <div className='w-full sm:text-base flex flex-col md:flex-row mt-4'>
          <div className='w-full md:w-1/4 pb-2 sm:pb-0 m-auto md:ml-0 mt-0 flex md:justify-start items-start'>
            <a href="https://www.linkedin.com/in/simran-kodwani-46ab70270" className='text-xl' ><BiLogoLinkedin /></a>
            <a href="https://github.com/SimranKodwani-2003" className='text-xl ml-6' ><BiLogoGithub /></a>
          ...
          <div className='w-full md:w-3/4 flex flex-row justify-start md:justify-between lg:justify-end text-start pt-2 md:pt-0 md:pl-4 lg:pl-10 '>
            ...
            <Link to='contact' smooth={true} offset={-80} duration={500} className='list-none text-gray-300 pb-3 md:pb-5 pl-7 cursor-pointer'>Contact me</Link>
          </div>
        </div>
      </div>
    </>
